...
<div class="top-bar-right">
    ...
    <div class="align-center text-center">
        ...
        <p><i>(Icon credits: <a href="https://icons8.com/icon/XNJzvoMWObVH/construction">Construction icon by Icons8</a>)</i></p>
                ...
                <!-- Content -->
                <p>Foundation Icons needed an npm module.
Why they don’t have one is beyond me.</p>

<h2 id="usage">Usage</h2>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install foundation-icons
</code></pre></div></div>

<p>Install Webpack loader</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install url-loader
npm install file-loader
</code></pre></div></div>

<p>Configure The WebPack Loaders</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">module</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">loaders</span><span class="p">:</span> <span class="p">[</span>
      <span class="c1">// the url-loader uses DataUrls.</span>
      <span class="c1">// the file-loader emits files.</span>
